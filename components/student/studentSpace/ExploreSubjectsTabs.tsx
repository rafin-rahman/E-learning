			...
			<TabsContent value="business">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Boss it in business with our specialist upskilling courses, industry
					...
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						...
						<div
							className={"flex flex-wrap sm:flex-nowrap gap-8  w-full justify-center"}
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										...
										manufacturing and find out how it works in a real-life situation.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										Learn how to harness Al technology to plan and deliver compelling
										content, automate marketing processes, and boost efficiency.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
			...
			<TabsContent value="healthcare">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Earning CPD and getting that all-important professional development has
							never been easier. Our expansive range of healthcare & medicine courses
							by leading experts will support your career journey – no matter where you
							want to go.
						</CardDescription>
					</CardHeader>
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						<div className={"flex flex-wrap w-2/3 items-stretch mr-10"}>
							<div>
								For nurses, pharmacists and clinical researchers alike, it all starts
								here. The work you do matters, and so does your future.
							</div>
							<div className={"border-l-2 border-red-400 pl-10"}>
								<Image
									src={"/icons/quote.png"}
									...
									alt="quote"
								/>{" "}
								Throughout the course there was an emphasis on reflection and self
								observation, which I found very insightful. I feel that as well as
								gaining practical strategies, I have learned something about myself too.{" "}
								<Image
									src={"/icons/quote.png"}
									className={"inline"}
									width={20}
						...
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Train the Healthcare Trainer</p>
									<div className="text-gray-700 text-xs  ">
										Learn how to deliver healthcare training using evidence-based teaching
										methods, and progress towards becoming an expert trainer.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										Explore critical perspectives on dying, death, and grief to develop
										your professional practice or reflect on personal experience.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
			...
			<TabsContent value="teaching">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Become an effective educational leader and confidently empower future
							generations with our rich portfolio of online teaching courses, covering
							everything from curriculum design to inclusive teaching.
						</CardDescription>
					</CardHeader>
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						<div className={"flex flex-wrap w-2/3 items-stretch mr-10"}>
							<div>
								As education experts ourselves, we'll help you master essential skills
								and teaching pedagogies. Start putting your professional development
								goals first.
							</div>
							<div className={"border-l-2 border-red-400 pl-10"}>
								<Image
									...
									alt="quote"
								/>{" "}
								The course was informative, interactive and useful. I will definitely
								use the methods and techniques of inclusion in my classroom. Thank you.{" "}
								<Image
									src={"/icons/quote.png"}
									className={"inline"}
									width={20}
						...
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										Learn how to teach entrepreneurial skills, inspire young people and
										transform teaching and learning to become more entrepreneurial
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										Learn how to transfer your teaching skills to an online context and
			...
			<TabsContent value="tech">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Step into the future with our ever-growing tech & IT portfolio, offering
							cutting-edge courses in topics like generative Al, programming and cyber
							security.
						</CardDescription>
					</CardHeader>
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						<div className={"flex flex-wrap w-2/3 items-stretch mr-10"}>
							<div>
								Learn from world-renowned industry experts such as Microsoft, CloudSwyft
								and Cisco, and start building a roster of skills that'll catapult you
								into the next generation of tech leaders.
							</div>
							<div className={"border-l-2 border-red-400 pl-10"}>
								<Image
									src={"/icons/quote.png"}
									...
									alt="quote"
								/>{" "}
								The course modules were well-structured, with clear explanations,
								relevant examples, and interactive exercises that allowed me to apply
								what I learned in a hands-on manner.{" "}
								<Image
									src={"/icons/quote.png"}
									className={"inline"}
									width={20}
						...
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Computer Programming for Everyone</p>
									<div className="text-gray-700 text-xs  ">
										Discover the art of computer programming and learn what code can do
										with the Institute of Coding and the University of Leeds.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Cisco: Python Programming (OpenEDG)</p>

									<div className="text-gray-700 text-xs  ">
										Prepare for a future in programming as you learn from experts at Cisco
			...
			<TabsContent value="psychology">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Become one of society's changemakers with our credible collection of
					...
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						<div className={"flex flex-wrap w-2/3 items-stretch mr-10"}>
							<div>
								Whether tackling trauma, mastering mindfulness or gearing up for a
								career as a psychologist, our expert-led courses and credentials will
								help you achieve career success and satisfaction.
							</div>
							<div className={"border-l-2 border-red-400 pl-10"}>
								<Image
									src={"/icons/quote.png"}
									...
									alt="quote"
								/>{" "}
								Great balance of research, personal stories and practical advice. Thank
								you.{" "}
								<Image
									src={"/icons/quote.png"}
									className={"inline"}
						...
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Neurodiversity in the Workplace</p>
									<div className="text-gray-700 text-xs  ">
										Develop your understanding of neurodiversity in the workplace to
										better support your neurodivergent colleagues or team members.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<div className="text-gray-700 text-xs  ">
										Gain critical knowledge and practical skills to identify and address
			...
			<TabsContent value="science">
				<Card className={"border-none shadow-none"}>
					<CardHeader>
						...
						<CardDescription>
							Uncover the rules of the universe and start building a new future with
							our innovative online science, engineering & maths courses.
						</CardDescription>
					</CardHeader>
					<CardContent className=" flex flex-wrap sm:flex-nowrap ">
						<div className={"flex flex-wrap w-2/3 items-stretch mr-10"}>
							<div>
								Guided by credible experts in fields such as genomics, quantum computing
								and climate science, you can upskill and prepare for a long and
								groundbreaking career in STEM.
							</div>
							<div className={"border-l-2 border-red-400 pl-10"}>
								<Image
									src={"/icons/quote.png"}
									...
									alt="quote"
								/>{" "}
								The course was very well-organised into manageable sections, with
								opportunities to hear from researchers in each field and suggested
								further learning links for personal study.{" "}
								<Image
									src={"/icons/quote.png"}
									className={"inline"}
									width={20}
						...
						>
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Batteries for the Energy Transition</p>
									<div className="text-gray-700 text-xs  ">
										Discover how batteries function, how they are produced, and what
										happens at the end of their life cycle.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
							...
							<div className="w-1/2 rounded overflow-hidden shadow-lg ">
								...
								<div className="px-6 py-4 ">
									...
									<p className={"font-bold mb-2"}>Data Analytics for Managers</p>

									<div className="text-gray-700 text-xs  ">
										Maximise the data analytics capabilities of your team to solve
										business problems or achieve business efticiencies.
									</div>
								</div>
								<div className="px-6 py-4">
									<p
