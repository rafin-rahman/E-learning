		...
		<div className={"relative container my-20"}>
			<div className={"fixed top-0 left-0 w-full h-full -z-10"}>
				<Image
					...
					alt={"logo"}
					className={
						"absolute object-cover h-1/2 blur-3xl -z-10 opacity-20"
					}
					fill
				/>
			</div>
			<div className={"relative sm:mx-32"}>
				...
				>
					...
					<div className={"w-64 font-medium leading-6"}>
						Make your 2024 count. Get Unlimited and access 1400+
						online courses from top universities.{" "}
					</div>
					<Button className={"bg-red-500 h-14"}>
			...
			<div
				className={
					"bg-white p-10 my-10 mt-24 rounded-2xl shadow-lg w-full"
				}
			>
					...
					<ul className={"mt-6"}>
						{listOfCourses.map((item) => {
							return (
								<li
									className={
										"my-4 py-1 text-center w-full bg-gray-100"
									}
								>
									{item}
								</li>
			...
			<h2 className={"text-4xl text-center font-black my-40"}>
				Learn with <span className={"text-red-500"}>200+</span>{" "}
