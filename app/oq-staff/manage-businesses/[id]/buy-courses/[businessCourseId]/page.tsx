		...
		<div>
					...
					<div className={"flex justify-around"}>
						<div>
							...
							>
								...
								<div className={"flex items-center gap-2"}>
									<UserGroupIcon className={"h-5"} /> 345
									Enrolled
								</div>{" "}
								<div className={"flex items-center gap-2"}>
								...
								<div className={"flex items-center gap-2"}>
									<TagIcon className={"h-5"} /> Business,
									Technology
								</div>{" "}
								<div className={"flex items-center gap-2"}>
			...
			<div className={"flex flex-wrap "}>
				<Tabs defaultValue={"overview"} className={"w-2/3 "}>
					<TabsList
						className={"grid w-full grid-cols-3 rounded-none p-0 "}
					>
						<TabsTrigger
							value={"overview"}
							className={
						...
						<TabsContent value={"overview"} className={"mt-0"}>
							<div className={"container py-6"}>
								<p>
									...
									adipiscing elit. Maecenas in finibus neque.
									Vivamus in ipsum quis elit vehicula tempus
									vitae quis lacus. Vestibulum interdum diam
									non mi cursus venenatis. Morbi lacinia
									libero et elementum vulputate. Vivamus et
									facilisis mauris. Maecenas nec massa auctor,
									ultricies massa eu, tristique erat. Vivamus
									in ipsum quis elit vehicula tempus vitae
									quis lacus. Eu pellentesque, accumsan tellus
									leo, ultrices mi dui lectus sem nulla eu.Eu
									pellentesque, accumsan tellus leo, ultrices
									mi dui lectus sem nulla eu. Maecenas arcu,
									nec ridiculus quisque orci, vulputate mattis
									risus erat.
								</p>
								...
								<ul>
									...
									<li>
										roin et eros varius, ornare turpis ac,
										dapibus nisi. Morbi luctus arcu non
										massa consequat, et tristique velit
										semper. Curabitur interdum vulputate
										sagittis. Donec erat massa, tincidunt
										sed feugiat id, suscipit in est. Proin
										laoreet orci quis augue eleifend varius.
										Donec hendrerit ex ut lacus blandit
										euismod.
									</li>
								</ul>
							</div>
				...
				>
					...
					<CardContent>
						...
						<ul className={""}>
							<li className={""}>
								<ChevronRightIcon
									className={"h-3 inline text-cyan-400"}
								/>
								English
							</li>
						</ul>
